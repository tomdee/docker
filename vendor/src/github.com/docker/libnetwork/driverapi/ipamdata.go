...
// MarshalJSON encodes IPData into json message
func (i *IPData) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON decodes a json message into IPData
func (i *IPData) UnmarshalJSON(data []byte) error {
	var (
		m   map[string]interface{}
		err error
	)
...
// Validate checks wheter the IPData structure contains congruent data
func (i *IPData) Validate() error {
	var isV6 bool
	if i.Pool == nil {
...
// IsV6 returns wheter this is an IPv6 IPData structure
func (i *IPData) IsV6() bool {
